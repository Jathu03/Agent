...
| :--- | :--- |
| **`multi-swarm.py`** | Implements **Swarm Architecture** using LangGraph. Orchestrates multiple specialized agents (Welcome, Calculator, Weather) with capability handoffs and exposes a streaming FastAPI endpoint. |
