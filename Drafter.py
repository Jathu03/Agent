...
@tool
def update(content: str)-> str:   # content will be given by the LLM in the background
...
def our_agent(state: AgentState)-> AgentState:
    ...
    You are a Drafter, a helpful writing assistant. You are going to help the use update and modify the documents.
...
def run_document_agent():
    ...
    for step in app.stream(state, mode = "values"):
        if "messages" in step:
